...
import com.internship.cafe_management.Repository.ProductRepository;
import com.internship.cafe_management.Service.ProductService;
        ...
        try{
            if (jwtFilter.isAdmin()){
                ...
                if (optional.isPresent()){
                    ...
                    return CafeUtils.getResponseEntity("Product deleted successfuully",HttpStatus.OK);
                }else{
                    return CafeUtils.getResponseEntity("Product id does not exist",HttpStatus.OK);
                }
            }else{
